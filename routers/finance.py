...
from database.queries import add_expense, get_expenses_by_period, get_expense_summary
...
async def cmd_budget(message: Message):
    """Set/view budget limits (placeholder for future implementation)"""
    await message.answer(
        "📋 <b>Budget Feature</b>\n\n"
        "Coming soon: Set monthly budgets per category and get alerts when approaching limits!\n\n"
        "For now, use /expenses to track your spending."
    )
